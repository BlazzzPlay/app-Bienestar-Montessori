...
### deploy-flow
- Path: /home/blazz/proyectos/bienestar-montessori/.agents/skills/deploy-flow/SKILL.md
- Trigger: Workflow completo de deploy: versionado, commit, push a GitHub y verificación post-deploy en Dokploy. Incluye guía de testing según los cambios realizados.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### design-taste-frontend
- Path: /home/blazz/proyectos/bienestar-montessori/.agents/skills/taste-skill/SKILL.md
...
### interface-design
- Path: /home/blazz/proyectos/bienestar-montessori/.agents/skills/interface-design/SKILL.md
...
### ui-ux-pro-max
- Path: /home/blazz/proyectos/bienestar-montessori/.agents/skills/ui-ux-pro-max/SKILL.md
