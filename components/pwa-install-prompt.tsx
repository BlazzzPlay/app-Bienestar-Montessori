...
export function PWAInstallPrompt() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4 pointer-events-none">
      <div className="bg-card rounded-xl shadow-xl border border-primary/10 overflow-hidden max-w-md mx-auto pointer-events-auto">
        ...
        <div className="p-4">
          ...
          <div className="bg-muted rounded-lg p-3 mb-4 border border-primary/10">
