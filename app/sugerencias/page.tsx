          ...
          <Card className="bg-blue-50 border-blue-200">
            <CardContent className="p-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                Este buzón de sugerencias es completamente <strong>anónimo</strong>. Puedes compartir tus ideas, quejas
                o sugerencias para mejorar nuestro programa de bienestar. Tu identidad no será revelada y todas las
                sugerencias serán revisadas por el comité de Bienestar.
              </p>
            </CardContent>
          </Card>
